          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative" data-aos="fade-down">
              ...
              >
                {items.map((item, index) => (
                  <Transition
                    ...
                    enterFrom="opacity-0 -tranblue-y-8"
                    enterTo="opacity-100 tranblue-y-0"
                    leave="transition ease-in-out duration-300 transform absolute"
                    leaveFrom="opacity-100 tranblue-y-0"
                    leaveTo="opacity-0 tranblue-y-8"
              ...
              <div className="absolute inset-0 flex items-center justify-between">
                <button
                  className="relative z-20 w-12 h-12 p-1 box-content flex items-center justify-center group transform -tranblue-x-2 md:-tranblue-x-1/2 bg-blue-500 hover:bg-blue-400 dark:bg-gray-800 dark:hover:bg-blue-500 dark:hover:bg-opacity-25 transition duration-150 ease-in-out"
                  onClick={() => {
