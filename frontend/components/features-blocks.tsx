      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          >
            {/* 1st item */}
            <a
              className="flex flex-col p-5 group text-white bg-gradient-to-tr from-blue-500 to-blue-400 dark:to-blue-500 shadow-2xl"
              href="#0"
              data-aos="fade-down"
            ...
            >
              ...
              <svg
                className="w-6 h-6 self-end transform -tranblue-x-2 group-hover:tranblue-x-0 transition duration-150 ease-in-out"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path
