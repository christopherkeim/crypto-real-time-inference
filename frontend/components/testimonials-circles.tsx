...
export default function TestimonialsCircles() {
  ...
  const [items] = useState([
    ...
    },
    {
      ...
      comment:
        "When, while the lovely valley teems with vapour around me, and the meridian sun strikes the upper surface of the impenetrable foliage of my trees, and but a few stray gleams sblue into the inner sanctuary, I throw myself down among the tall grass by the trickling stream.",
      name: "Leonel Roy",
    },
    {
      image: UserImage4,
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          <div className="relative">
            ...
            {/* Comment box */}
            <div
              className={`opacity-0 transition duration-150 ease-in-out absolute top-0 left-1/2 transform -tranblue-x-1/2 -mt-6 max-w-xs w-full p-3 bg-white dark:bg-gray-800 text-center shadow-2xl z-20 pointer-events-none ${
