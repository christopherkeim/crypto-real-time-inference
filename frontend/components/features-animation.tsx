            ...
            <div className="relative flex justify-center items-center overflow-hidden">
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  ...
                  <g transform="tranblue(22 22)" stroke="#1D1D20">
              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute font-medium px-4 py-2 text-white dark:text-blue-500 bg-gradient-to-tr from-blue-500 to-blue-400 dark:bg-blue-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-1 mt-72">
                  Components
                </div>
                ...
                <div className="absolute font-medium px-4 py-2 text-white dark:text-blue-500 bg-gradient-to-tr from-blue-500 to-blue-400 dark:bg-blue-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-5 mt-14">
                  Tools & Widgets
                </div>
                ...
                <div className="absolute font-medium px-4 py-2 text-white dark:text-blue-500 bg-gradient-to-tr from-blue-500 to-blue-400 dark:bg-blue-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-9 mt-80 top-4">
                  Perks
                </div>
                <div className="absolute font-medium px-4 py-2 text-white dark:text-blue-500 bg-gradient-to-tr from-blue-500 to-blue-400 dark:bg-blue-500 dark:from-transparent dark:to-transparent dark:bg-opacity-25 rounded-full inline-flex items-center justify-center tags-animation tags-10 mt-56">
                  Product & Design
                </div>
              </div>
